  ...
  return (
    ...
    >
      <div className="flex flex-col justify-start gap-4 md:gap-6 w-full max-w-2xl">
        ...
        <button className="bg-white text-black font-bold text-base sm:text-lg md:text-xl px-4 sm:px-6 md:px-10 py-2 sm:py-3 md:py-4 rounded-full shadow-lg hover:bg-gray-200 transition duration-300 flex items-center justify-center gap-2 sm:gap-3 tracking-wide w-fit mx-auto md:mx-0">
          Apply Now
